...
group = "io.github.bhuyanp.notification"
...
openApiGenerate {
	...
	inputSpec.set("$projectDir/notification-service-spec-v1.json")
...
tasks.openApiGenerate {
	doFirst {
		...
		delete("$clientTargetFolder/java/io/github/bhuyanp/notification/client/model")
		delete("$clientTargetFolder/java/io/github/bhuyanp/notification/client/api")
	}
}
