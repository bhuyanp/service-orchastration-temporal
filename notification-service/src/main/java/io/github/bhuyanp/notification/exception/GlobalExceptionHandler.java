package io.github.bhuyanp.notification.exception;
...
//        }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        ProblemDetail problemDetail = createProblemDetail(ex, status, "Failed to read the request", null, null, request);
        problemDetail.setProperties(Map.of(
