...
group = "io.github.bhuyanp.inventory"
...
openApiGenerate {
    ...
    inputSpec.set("$projectDir/inventory-service-spec-v1.json")
...
tasks.openApiGenerate {
    doFirst {
        ...
        delete("$clientTargetFolder/java/io/github/bhuyanp/inventory/client/model")
        delete("$clientTargetFolder/java/io/github/bhuyanp/inventory/client/api")
    }
}
