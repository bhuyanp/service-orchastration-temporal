...
public class OrderInitiationWorkflowImpl implements OrderInitiationWorkflow {
    ...
    @Override
    public Order startOrder(OrderRequest orderRequest) {
        Order order = orderInitiationActivity.addOrder(orderRequest);
        ...
        ChildWorkflowOptions options =
                ChildWorkflowOptions.newBuilder()
                        ...
                        .setWorkflowId(ORDER_WORKFLOW_ID_PREFIX + order.orderId())
                        .build();
